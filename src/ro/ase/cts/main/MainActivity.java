...
public class MainActivity {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println();
		System.out.println(pacient1.getSectorNastere());
		System.out.println(medic1.salariu());
		
		pacient1.verificareLungimeCNP();
	    ...
	    //Scrierea in fisier text
	 	try {
			File fisier = new File("clinica.txt");
			FileWriter scriereFisier = new FileWriter(fisier);
			BufferedWriter buffer = new BufferedWriter(scriereFisier);
			buffer.write(clinica.toString());
			buffer.close();
			scriereFisier.close();
	 	...
	 	System.out.println("---Citirea din fisier---");
		//Citirea din fisier text
		try {
			File fisier = new File("clinica.txt");
			FileReader citireFisier = new FileReader(fisier);
			BufferedReader buffer = new BufferedReader(citireFisier);
